            ...
            <table  class="table table-dark" style="width: 400px;margin-left: 480px">
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" name="txtNombreJugador" value="" placeholder="ingresar nombre jugador" onblur="limpia()"  onkeypress="return soloLetras(event)"/></td>
                    </tr>
                    <tr>
                        <td><label>Apellido Paterno: </label></td>
                        <td><input type="text" name="txtApellidoPaterno" value="" placeholder="ingresar apellido jugador" onblur="limpia()"  onkeypress="return soloLetras(event)"/></td>
                    </tr>
                    <tr>
                        <td><label>Rut: </label></td>
                        <td><input type="text" name="txtRutJugador" value="" placeholder="ingresar rut jugador" onblur="limpia()"  onkeypress="return soloLetras(event)"/></td>
                    </tr>
                    <tr>
                        <td><label>Usuario: </label></td>
                        <td><input type="text" name="txtUser" value="" placeholder="ingresar nombre usuario" onblur="limpia()"  onkeypress="return soloLetras(event)"/></td>
                    </tr>
                    <tr>
                        <td><label>Contraseña: </label></td>
                        <td><input type="text" name="txtContrasenia" value="" placeholder="ingresar nombre jugador" onblur="limpia()"  onkeypress="return soloLetras(event)"/></td>
                    </tr>
                    <tr>
